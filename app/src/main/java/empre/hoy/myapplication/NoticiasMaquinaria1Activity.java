...
public class NoticiasMaquinaria1Activity extends AppCompatActivity {
    FrameLayout flayNoticias, flayPublicidad, flayRevistas;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_noticias_maquinaria_1);
        ...
        flayNoticias.setOnClickListener(v -> {
            startActivity(new Intent(NoticiasMaquinaria1Activity.this, NoticiasMaquinaria2Activity.class));
        });
    }
}
