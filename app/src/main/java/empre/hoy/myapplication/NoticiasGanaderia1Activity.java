...
public class NoticiasGanaderia1Activity extends AppCompatActivity {
    FrameLayout flayNoticias, flayPublicidad, flayRevistas;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_noticias_ganaderia_1);
        ...
        flayNoticias.setOnClickListener(v -> {
            startActivity(new Intent(NoticiasGanaderia1Activity.this, NoticiasGanaderia2Activity.class));
        });
    }
}
