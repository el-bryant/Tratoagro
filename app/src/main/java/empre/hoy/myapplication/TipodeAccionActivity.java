...
public class TipodeAccionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        acvvacablanco.setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        acvpescablanco.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
        ...
        acvvegetalesblanco.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                acvvacadorado.setVisibility(View.GONE);
        ...
        acvmaquinariablanco.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                acvvacadorado.setVisibility(View.GONE);
        ...
        acvpesticidablanco.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                acvvacadorado.setVisibility(View.GONE);
        ...
        acvfertilizanteblanco.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
                acvvacadorado.setVisibility(View.GONE);
