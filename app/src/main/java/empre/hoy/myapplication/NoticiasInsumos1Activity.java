...
public class NoticiasInsumos1Activity extends AppCompatActivity {
    FrameLayout flayNoticias, flayPublicidad, flayRevistas;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_noticias_insumos_1);
        ...
        flayNoticias.setOnClickListener(v -> {
            startActivity(new Intent(NoticiasInsumos1Activity.this, NoticiasInsumos2Activity.class));
        });
    }
}
